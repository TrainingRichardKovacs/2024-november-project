...
def create_tables_flow():
    ...
    for file in files:
        ...
        create_path = rf"C:\WORK\Prooktatas\2024-november-project\sql_scripts\create_{file_name}.sql"
        insert_path = rf"C:\WORK\Prooktatas\2024-november-project\sql_scripts\insert_{file_name}.sql"
